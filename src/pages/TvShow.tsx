...
import { modifyNumber, modifyString } from "../utils/functions";
    ...
    <>
      ...
      <div className="md:px-10 px-6 py-12 flex flex-wrap gap-10 ">
        ...
        <div className="min-w-full">
          ...
          {Object.values(showCast?.cast).length > 15 && (
            <p className="text-xl text-center w-full text-gray-400 font-bold">
              <a
                href={`https://www.themoviedb.org/tv/${tvShowId}/cast`}
                target="_blank"
              >
                View entire cast
              </a>
        ...
        <div>
          ...
          <MultiCardSlider
            data={similarShows?.results?.filter(
